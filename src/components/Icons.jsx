...
// Gmail / Email Branding Icon
export const GmailIcon = ({ className = "" }) => (
  <svg viewBox="0 0 24 24" className={className} fill="#EA4335" aria-hidden="true">
...
// Behance Branding Icon
export const BehanceIcon = ({ className = "" }) => (
  <svg viewBox="0 0 24 24" className={className} fill="#0057FF" aria-hidden="true">
    <path d="M22 7h-7V5h7v2zm1.726 10c-.442 1.297-2.029 3-4.726 3-3.031 0-5.5-2.062-5.5-5.5 0-3.219 2.375-5.5 5.5-5.5 3.328 0 5.25 2.453 5.016 5.5h-7.859c.141 1.766 1.484 2.875 3.094 2.875 1.344 0 2.297-.672 2.703-1.625l1.772 1.25zm-7.515-4h5.188c-.125-1.375-1.078-2.25-2.5-2.25s-2.5.875-2.688 2.25zM0 4h7.5c2.5 0 4.5 1.2 4.5 3.5 0 1.4-.8 2.5-2 3 1.6.5 2.5 1.8 2.5 3.5 0 2.6-2.1 4-4.8 4H0V4zm3 3.5v3h4.2c1.2 0 2-.6 2-1.5s-.8-1.5-2-1.5H3zm0 5.5v3.5h4.5c1.3 0 2.2-.7 2.2-1.7s-.9-1.8-2.2-1.8H3z" />
  </svg>
);
